"""
Runtime hook for PyInstaller to set up GObject Introspection environment (Linux)
"""
import os
import sys
...
if hasattr(sys, '_MEIPASS'):
    ...
    if os.path.exists(glib_schemas):
        ...
        schemas_compiled = os.path.join(glib_schemas, 'gschemas.compiled')
        if not os.path.exists(schemas_compiled):
            try:
                import subprocess
